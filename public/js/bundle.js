      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'You have loggined successfully!');
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          baseURL = 'http://localhost:3000';
          loginEndpoint = '/api/v1/users/logout';
          _context2.prev = 2;
          _context2.next = 5;
          return (0, _axios.default)({
            method: 'get',
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiamFjazVtIiwiYSI6ImNsODV3M3F6bDB1MmozdnA2Zm5ucmI3MjIifQ.CunhSu7Jv2-04vOhSrSfxw';
